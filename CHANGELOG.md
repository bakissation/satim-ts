...
> **This file is frozen at `1.1.0`.** From the next release onward, versioning and
> release notes are automated by [semantic-release](https://semantic-release.gitbook.io/)
> from Conventional Commits. See the **[GitHub Releases](https://github.com/bakissation/satim-ts/releases)**
> page for all changes after `1.1.0`.
